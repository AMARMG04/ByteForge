  ...
  return (
    <div>
      {step === 1 && (
        <div className="grid grid-cols-1 gap-6 mt-5">
          <label className="flex flex-col gap-4">
            <span className="text-4xl w-64 block font-medium lg:text-4xl lg:w-full text-teal-500">
      ...
      {step === 2 && (
        <div className="grid grid-cols-1 gap-6 mt-5">
          <label className="flex flex-col gap-4">
            <span className="text-4xl w-64 block font-medium lg:text-4xl text-teal-500">
              Enter OTP
            </span>
            ...
            />
            <p>Didn't receive OTP yet?<span className="ml-2 underline underline-offset-2">Resend</span></p>
